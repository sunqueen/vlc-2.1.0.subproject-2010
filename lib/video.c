...
int libvlc_video_get_size( libvlc_media_player_t *p_mi, unsigned num,
                           unsigned *__restrict px, unsigned *__restrict py )			// sunqueen modify
{
...
int libvlc_video_get_cursor( libvlc_media_player_t *mp, unsigned num,
                             int *__restrict px, int *__restrict py )			// sunqueen modify
{
...
static void
set_int( libvlc_media_player_t *p_mi, const char *__restrict name,
         const opt_t *__restrict opt, int value )			// sunqueen modify
{
    if( !opt ) return;
...
static int
get_int( libvlc_media_player_t *p_mi, const char *__restrict name,
         const opt_t *__restrict opt )			// sunqueen modify
{
    if( !opt ) return 0;
...
static void
set_float( libvlc_media_player_t *p_mi, const char *__restrict name,
            const opt_t *__restrict opt, float value )			// sunqueen modify
{
    if( !opt ) return;
...
static float
get_float( libvlc_media_player_t *p_mi, const char *__restrict name,
            const opt_t *__restrict opt )			// sunqueen modify
{
    if( !opt ) return 0.0;
...
static void
set_string( libvlc_media_player_t *p_mi, const char *__restrict name,
            const opt_t *__restrict opt, const char *__restrict psz_value )			// sunqueen modify
{
    if( !opt ) return;
...
static char *
get_string( libvlc_media_player_t *p_mi, const char *__restrict name,
            const opt_t *__restrict opt )			// sunqueen modify
{
    if( !opt ) return NULL;
