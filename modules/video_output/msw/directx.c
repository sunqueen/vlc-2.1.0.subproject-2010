...
#ifdef UNICODE
//# warning "Unicode mode not tested"			// sunqueen delete
#endif
                                            ...
                                            HMONITOR hmon)
{
    ...
    char *psz_drivername = FromT((const char *)drivername);			// sunqueen modify
    char *psz_desc = FromT((const char *)desc);			// sunqueen modify
                                ...
                                int backbuffer_count)
{
    ...
    HRESULT hr = IDirectDrawSurface_QueryInterface(surface_v1,
                                                   ...
                                                   (LPVOID *)surface);			// sunqueen modify
